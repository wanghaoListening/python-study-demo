...
class BaseModel(object):
    """Generic class for general methods that are not specific to PCNN"""
    ...
    def restore_session(self, dir_model):
        ...
        """
        self.logger.info("Reloading the model in {}...".format(dir_model))
    ...
    def train(self, train, dev):
        ...
        for epoch in range(self.config.nepochs):
            ...
            if self.config.early_stop:
                ...
                if score >= best_score:
                    nepoch_no_imprv = 0
                    self.save_session("early_best.ckpt")
                    best_score = score
